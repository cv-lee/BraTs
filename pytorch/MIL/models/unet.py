...
class UNet(nn.Module):
    def __init__(self, in_channel=1, class_num=2, useBN=False, drop_rate=0):
        ...
        self.extractor3 = extractor
        self.extractor4 = extractor

        self.conv1 = conv3x3(128, 128, useBN=useBN, drop_rate=self.drop_rate)
        self.conv2 = conv3x3(128, 128, useBN=useBN, drop_rate=self.drop_rate)
        self.conv3 = conv3x3(128, 128, useBN=useBN, drop_rate=self.drop_rate)
        self.conv4 = conv3x3(128, 128, useBN=useBN, drop_rate=self.drop_rate)
        self.conv5 = conv3x3(128, 128, useBN=useBN, drop_rate=self.drop_rate)

        self.conv4m = conv3x3(256, 256, useBN=useBN, drop_rate=self.drop_rate)
        self.conv3m = conv3x3(256, 256, useBN=useBN, drop_rate=self.drop_rate)
        self.conv2m = conv3x3(256, 128, useBN=useBN, drop_rate=self.drop_rate)
        self.conv1m = conv3x3(256, 128, useBN=useBN, drop_rate=self.drop_rate)
        ...
        self.upsample54 = upsample(128, 128, drop_rate=self.drop_rate)
        self.upsample43 = upsample(128, 128, drop_rate=self.drop_rate)
        self.upsample32 = upsample(128, 128, drop_rate=self.drop_rate)
        self.upsample21 = upsample(128, 128, drop_rate=self.drop_rate)
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        x3 = self.extractor3(x3)
        x4 = self.extractor4(x4)
