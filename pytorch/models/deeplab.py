...
def conv3x3_simple(in_planes, out_planes, stride=1):
...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.atr_conv1 = atrous_conv(512, 128, 6)
        self.atr_conv2 = atrous_conv(512, 128, 12)
        self.atr_conv3 = atrous_conv(512, 128, 18)
        #self.avgpool = nn.AvgPool2d(2) #impossible due to 15/2 = 7.5
        #self.conv2 = conv1x1(512, 128)
        self.conv_cat = conv1x1(512, 128)
...
class Deeplab_V3_Plus(nn.Module):
    ...
    def __init__(self, class_num=2):
        ...
        self.conv0 = conv1x1(64, 48)
        self.encoder = Encoder()
        self.conv1 = conv3x3(176, 124)
        self.conv2 = conv3x3(124, 124)
        self.conv3 = conv3x3(124, class_num)
